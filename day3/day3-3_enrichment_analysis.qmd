...
{{< downloadthis ../assets/pdf/11_Enrichment_analysis_jk.pdf dname="Enrichment_analysis" label="Download the presentation" icon="filetype-pdf" >}}
...
### Save data and clear environment

```{r}
#| echo: true

saveRDS(tum_vs_norm, "day3/tum_vs_norm_go.rds")
saveRDS(limma_de, "day3/enr_go.rds")
saveRDS(proB, "day3/tum_vs_norm_enrich.rds")
```
