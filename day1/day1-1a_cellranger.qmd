---
title: "Introduction & cellranger (advanced)"
---
...
{{< downloadthis ../assets/pdf/03_10x_genomics_single_cell_jk.pdf dname="03_10x_genomics_single_cell" label="Download the presentation" icon="filetype-pdf" >}}
...
**These exercises are not essential to run for the rest of the course**, so we will can skip them. If you want to do them on your own, you can try to [install `cellranger` to your computing environment](https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/installation) (only on Linux or WSL). In addition, you will need to download the references. You can get it by with this code (choose your OS):
...
::: {.callout-important}
## Exercise
Run the `cellranger count` using command below:
...
Once started, the process will need approximately 15 minutes to finish. 
::: 

Have a look out the cellranger output directory (i.e. `~/ETV6-RUNX1_1/outs`). The analysis report (`web_summary.html`) is usually a good place to start. 
