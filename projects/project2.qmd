...
```{r}
system('cp -v /gpfs/helios/projects/elixir_scRNA-seq/input_data/projects_data/project2.zip . && unzip ./project2.zip')
```
...
Now create Seurat object from the count matrices. Optionally, create a new project in the `project2` directory (Project (None) > New Project ...):
