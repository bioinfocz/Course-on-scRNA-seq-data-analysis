...
```{r}
system('cp -v /gpfs/helios/projects/elixir_scRNA-seq/input_data/projects_data/project1.zip . && unzip ./project1.zip')
```
...
Now create Seurat object from the count matrices. Optionally, create a new project in the `project1` directory (Project (None) > New Project ...):
