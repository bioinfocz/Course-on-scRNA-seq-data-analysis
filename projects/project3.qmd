...
In order to retrieve the data, run:

```{r}
#| eval: false
system('cp -v /gpfs/helios/projects/elixir_scRNA-seq/input_data/projects_data/project3.zip . && unzip ./project3.zip')
```
...
Now create Seurat object from the count matrices. Optionally, create a new project in the `project3` directory (Project (None) > New Project ...):
