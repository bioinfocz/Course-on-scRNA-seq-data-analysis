...
```{r}
#| eval: false
system('cp -v /gpfs/helios/projects/elixir_scRNA-seq/input_data/projects_data/project4.zip . && unzip ./project4.zip')
```
...
Now create Seurat object from the count matrices. Optionally, create a new project in the `project4` directory (Project (None) > New Project ...):
