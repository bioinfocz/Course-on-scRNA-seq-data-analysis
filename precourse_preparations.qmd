...
Participants should already have a basic knowledge in Next Generation Sequencing (NGS) techniques. Knowledge in RNA sequencing is a plus. A basic knowledge of the R statistical software is **required**. Test your R skills with the quiz [here](https://docs.google.com/forms/d/e/1FAIpQLSdIyeuabd_ZOWXgI1MWHapmaOMu20L9ESkLDZiWnpmkpujyOg/viewform?usp=sf_link), before registering.
